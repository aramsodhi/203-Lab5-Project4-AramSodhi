...
public final class EventScheduler {
    ...
    public void scheduleEvent(Entity entity, Task task, double afterPeriod) {
        double time = this.currentTime + afterPeriod;

        Event event = new Event(task, time, entity);
    ...
    /** Execute all scheduled tasks up to the given time from the last update. */
